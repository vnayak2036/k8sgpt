...
type IAI interface {
	...
	GetCompletion(ctx context.Context, prompt string, prompt_name ...string) (string, error)
	Parse(ctx context.Context, prompt []string, cache cache.ICache, kind ...string) (string, error)
	GetName() string
}
